...
def main():
    ...
    document_df = pl.read_parquet('./data/stance_targets/1day_doc_targets.parquet.zstd')
    ...
    document_df.write_parquet('./data/stance_targets/1week_doc_targets_with_stance.parquet.zstd')
